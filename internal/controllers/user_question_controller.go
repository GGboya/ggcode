...
type UserQuestionController struct {
	userQuestionService *services.UserQuestionService
}

func NewUserQuestionController(userQuestionService *services.UserQuestionService) *UserQuestionController {
